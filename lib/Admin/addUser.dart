                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: <String>['admin','worker' ,'manger', 'المخارط البلدى', 'مثاقيب النحاس الاصفر','المكابس','الفرايز CNC','المخارط CNC','مقاشط','لحام دور ارضي','المخزن الفرعى','التقطيع','التكويع اليدوي','التكويع CNC','مثاقيب النحاس الاحمر','لحام الاكسيجين','لحام الكهرباء','الفرز والتعبئة والتغليف']
